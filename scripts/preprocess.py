...
# ----------------------------------------------------
# Agar Python dapat menemukan utils/text_processor.py
# ----------------------------------------------------
...
def main():
    ...
    # ----------------------------------------------------
    # Normalisasi dasar dan deduplikasi
    # ----------------------------------------------------
    df = df.dropna()
    # Gabungkan clean_text dan TextProcessor.normalize
    df['kata'] = df['kata'].apply(lambda x: tp.normalize(clean_text(x)))
